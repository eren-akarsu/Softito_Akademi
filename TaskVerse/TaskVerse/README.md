...
*Uygulamada giriş yapmamış (unauthenticated) kullanıcılar doğrudan `Login` bileşenine yönlendirilir.*
...
*Sisteme giriş için bu JSON dosyasındaki hesaplar kullanılır (Tüm varsayılan şifreler: `1234` olarak belirlenmiştir).*
